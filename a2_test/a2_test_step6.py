...
from goal import flatten, PerimeterGoal
    ...
    def test_flatten_5(self):
        ...
        while len(bfs) != 0:
            ...
            for temp in child.children:
                bfs.append(temp)
        res2 = flatten(self.one_internal)
